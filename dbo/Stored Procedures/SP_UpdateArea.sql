CREATE   PROCEDURE [dbo].[usp_UpdateArea] (@ID INT, @NOMBRE VARCHAR(MAX) = NULL, @FK_ID_DEPARTAMENTO INT = NULL, @ACTIVO BIT = NULL)
AS
BEGIN
	---Declaracion Variables
    DECLARE @MetodoTemporal VARCHAR(MAX) = 'usp_UpdateArea';
