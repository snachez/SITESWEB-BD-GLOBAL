CREATE   PROCEDURE [dbo].[usp_UpdateDiasHabilesEntregaPedidosInternos](
  @DIA											INT
, @ID											INT
, @PERMITE_REMESAS								BIT
		...
		END
			...
			---
			  ...
			  BEGIN
				  ...
				  EXEC usp_VALIDACION_CONTRAINT_MODIFICACION_MISMO_DIA_VALIDACIONES_tblDiasHabilesEntregaPedidosInternos
